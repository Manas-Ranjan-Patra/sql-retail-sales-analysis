...
```sql
SELECT 
    category, COUNT(DISTINCT customer_id) unique_customer
FROM
    retail_sales
GROUP BY category;
```
...
## Author - Manas Ranjan Patra

This project is part of my portfolio, showcasing the SQL skills essential for data analyst roles. If you have any questions, feedback, or would like to collaborate, feel free to get in touch!
- **LinkedIn**: [Connect with me profile](https://www.linkedin.com/in/manas-ranjan-patra-4171b02a9/)
